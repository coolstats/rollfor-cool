...
local function get_dummy_candidates()
  return {
    { name = "Testwarrior", class = "Warrior", value = 1 },
    { name = "Testdruid",   class = "Druid",   value = 2 },
    { name = "Testhunter",  class = "Hunter",  value = 3 },
    { name = "Testshaman",  class = "Shaman",  value = 4 },
    { name = "Testpriest",  class = "Priest",  value = 5 },
    { name = "Testpaladin", class = "Paladin", value = 6 },
    { name = "Testrogue",   class = "Rogue",   value = 7 },
    { name = "Testmage",    class = "Mage",    value = 8 },
    { name = "Testwarlock", class = "Warlock", value = 9 },
  }
end
...
function M.new( api, group_roster, loot_list )
    ...
    for i = 1, 40 do
      ...
      if m.vanilla or m.wotlk then
        ...
        -- Non-vanilla clients require the slot
